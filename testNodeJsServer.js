...
router.route('/songs')
   ...
   .get(function(req, res) {
	...
	/*
	* Posts the selected song to the specified playlist in the database.
	* Input: Requires a song object to be passed in with the playlist code appended as playlist.
	*/
